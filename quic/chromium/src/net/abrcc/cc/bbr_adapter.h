#ifndef ABRCC_CC_BBR_ADAPTER_H_
#define ABRCC_CC_BBR_ADAPTER_H_
...
// BbrAdapter implements BBR congestion control algorithm.  BBR aims to estimate
...
// pacing is disabled.
class QUIC_EXPORT_PRIVATE BbrAdapter : public SendAlgorithmInterface {
 public:
  /**
  ...
  struct QUIC_EXPORT_PRIVATE DebugState {
    explicit DebugState(const BbrAdapter& sender);
  ...
  BbrAdapter(const BbrAdapter&) = delete;
  BbrAdapter& operator=(const BbrAdapter&) = delete;
  ~BbrAdapter() override;
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os,
                                             const BbrAdapter::Mode& mode);
QUIC_EXPORT_PRIVATE std::ostream& operator<<(
    std::ostream& os,
    const BbrAdapter::DebugState& state);
