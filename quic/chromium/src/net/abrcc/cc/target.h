#ifndef ABRCC_CC_TARGET_H_
#define ABRCC_CC_TARGET_H_
...
class QUIC_EXPORT_PRIVATE BbrTarget : public SendAlgorithmInterface {
 public:
  ...
  struct QUIC_EXPORT_PRIVATE DebugState {
    explicit DebugState(const BbrTarget& sender);
  ...
  BbrTarget(const BbrTarget&) = delete;
  BbrTarget& operator=(const BbrTarget&) = delete;
  ~BbrTarget() override;
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os,
                                             const BbrTarget::Mode& mode);
QUIC_EXPORT_PRIVATE std::ostream& operator<<(
    std::ostream& os,
    const BbrTarget::DebugState& state);
